...
exports.generateSubtitles = async (req, res) => {
  try {
...
exports.generateMultiLanguageSubtitles = async (req, res) => {
  try {
...
exports.burnSubtitles = async (req, res) => {
  try {
...
exports.embedSubtitles = async (req, res) => {
  try {
...
exports.burnSubtitlesDirect = async (req, res) => {
  try {
